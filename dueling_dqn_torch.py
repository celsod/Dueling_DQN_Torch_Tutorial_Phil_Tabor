...
class ReplayBuffer(object):
    def __init__(self, max_size, input_shape, n_actions):
        ...
        self.terminal_memory = np.zeros(self.mem_size, dtype=np.uint8)  # unsigned integer meaning the program is expecting only positive values
...
class DuelingLinearDeepQNetwork(nn.Module):
    def __init__(self, ALPHA, n_actions, name, input_dims, chkpt_dir='temp/dueling_dqn'):
